...
class Company(models.Model):
    ...
    phone = models.CharField(
        max_length=20, null=True, blank=True, verbose_name="Telefone da Empresa"
    )
    ...
    number = models.CharField(
        max_length=20, null=True, blank=True, verbose_name="Número"
    )
    complement = models.CharField(
        max_length=150, null=True, blank=True, verbose_name="Complemento"
    )
    ...
    alternative_email = models.EmailField(
        max_length=254, null=True, blank=True, verbose_name="E-mail Alternativo"
    )
    description = models.TextField(
        null=True, blank=True, verbose_name="Descrição, resumo, valores"
    )
